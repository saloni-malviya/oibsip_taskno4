...
public class OnlineExam {
    ...
    public void main()
    {
        System.out.println("Enter '1' for Update Profile and Password");
        System.out.println("Enter '2' for Start test");
        System.out.println("Enter '3' for Closing Session and Logout");
